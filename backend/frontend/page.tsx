...
export default function Home() {
  ...
  const verdictStyles = useMemo(() => {
    ...
    if (verdict.includes("verification")) {
      return {
  ...
  const fallbackRecommendation = useMemo(() => {
    ...
    if (result.score >= 50) {
      return "This result is inconclusive. Use additional checks before making a decision.";
    }
      ...
      <div className="mx-auto max-w-6xl">
              ...
              <div className="space-y-5">
                ...
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-200">
                    {result.recommendation || fallbackRecommendation}
                  </p>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-4">
                    ...
                    <p className="mt-1 font-medium">
                      {result.mediaType === "video" ? "Video analysis" : "Image analysis"}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-8 rounded-3xl border border-zinc-800 bg-zinc-950/70 p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-400">
            ...
            detection. Results are useful for triage, but they are not absolute proof.
            For important content, combine this result with source verification and
            context checks.
          </p>
        </div>
      </div>
